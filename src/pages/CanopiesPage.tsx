...
import { Phone, MessageCircle, ArrowLeft, CheckCircle2, Settings } from "lucide-react";
...
const CanopiesPage = () => {
  ...
  useSEO({
    title: `${service.title} في مكة المكرمة والمدينة المنورة`,
            ...
            <div className="max-w-4xl">
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-accent text-white font-bold shadow-lg hover:shadow-xl transition-all"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-white/10 border-2 border-white/20 text-white font-bold hover:bg-white/20 transition-all"
                >
                  <Phone size={20} />
                  اتصل الآن
                </a>
            ...
            <div className="max-w-4xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {service.benefits.map((benefit) => (
                  <div
                    key={benefit}
                    className="flex items-start gap-3 p-4 rounded-lg border-2 border-primary/10 bg-secondary/5"
                  >
            ...
            <div className="max-w-4xl">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {service.serviceTypes.map((type) => (
                  <div
                    key={type.title}
                    className="p-6 rounded-xl border-2 border-primary/10 bg-white shadow-sm"
                  >
            ...
            <div className="max-w-4xl space-y-12">
              {service.contentSections.map((section) => (
                ...
                >
                  ...
                  <div className="relative overflow-hidden rounded-xl border-2 border-primary/10">
                    <img
                      src={`/${service.folder}/${section.imageIndex + 1}.webp`}
                      alt={section.title}
          ...
          <div className="section-container text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              {client.serviceAreas.map((area) => (
                <span
                  key={area}
                  className="px-4 py-2 rounded-full bg-white/10 text-white font-semibold"
                >
                  {area}
                </span>
              ))}
