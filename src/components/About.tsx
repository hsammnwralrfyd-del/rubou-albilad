          ...
          <div className="min-w-0 space-y-6">
            <div>
              ...
              <p className="text-sm leading-8 text-secondary sm:text-base">
                نحن حداد مظلات وسواتر متخصص في تصميم وتنفيذ المظلات والسواتر والبرجولات والهناجر في مكة المكرمة والمدينة المنورة. نقدم حلولًا متكاملة من التخطيط حتى التسليم، مع التركيز على الجودة واللمسات الفنية التي تجمع بين المتانة والجمال.
              </p>
            </div>
